...
(function ($) {
	...
	$("#tt-m-menu-toggle-btn-wrap").on("click", function() {
		...
		if ($("body").hasClass("tt-m-menu-open")) {
			...
			// Menu in animations
			var tl_Meajun = gsap.timeline({
				onComplete: function() { 
					$("body").removeClass("tt-m-menu-toggle-no-click"); 
				}
			});

				 tl_Meajun.to(".tt-main-menu", { duration: 0.4, autoAlpha: 1 });
				 tl_Meajun.from(".tt-main-menu-content > ul > li", { duration: 0.4, y: 80, autoAlpha: 0, stagger: 0.05, ease: Power2.easeOut, clearProps:"all" });
	...
	$olMenuToggleBtn.on("click", function() {
		...
		if ($("body").hasClass("tt-ol-menu-open")) {
			...
			var tl_olMeajun = gsap.timeline({
				onComplete: function() { 
					$("body").removeClass("olm-toggle-no-click"); 
				}
			});

				 tl_olMeajun.to(".tt-overlay-menu", { duration: 0.4, autoAlpha: 1 });
				 tl_olMeajun.from(".tt-ol-menu-list > li", { duration: 0.4, y: 80, autoAlpha: 0, stagger: 0.05, ease: Power2.easeOut, clearProps:"all" });
				 if ($(".tt-ol-menu-social").length) {
				 	tl_olMeajun.to(".tt-ol-menu-social", { duration: 0.4, autoAlpha: 1 }, "-=0.4");
				 	tl_olMeajun.from(".tt-ol-menu-social > li", { duration: 0.4, y: 80, autoAlpha: 0, stagger: 0.05, ease: Power2.easeOut, clearProps:"all" }, "-=0.4");
				 }
				 if ($(".tt-ol-menu-ghost").length) {
				 	tl_olMeajun.from(".tt-ol-menu-ghost", { duration: 0.4, y: 80, autoAlpha: 0, ease: Power2.easeOut, clearProps:"all" }, "-=0.4");
				 }
